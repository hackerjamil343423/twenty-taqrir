  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-10">
        ...
        <p className="text-gunmetal-gray text-sm">أنشئ حسابك وابدأ مجاناً</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label htmlFor="name" className="block text-sm font-medium text-midnight-ink mb-2">
            الاسم الكامل
          </label>
          <input
            id="name"
        ...
        <div className="flex items-start gap-2 text-sm">
          <input type="checkbox" className="w-4 h-4 mt-0.5 rounded border-soft-concrete" required />
          <span className="text-gunmetal-gray">
            أوافق على{" "}
            <a href="/terms" className="text-highlight-orange hover:underline">الشروط والأحكام</a>
            {" "}و{" "}
            <a href="/privacy" className="text-highlight-orange hover:underline">سياسة الخصوصية</a>
          </span>
        </div>
      ...
      <div className="mt-8">
        <div className="relative">
          ...
          <div className="relative flex justify-center">
            <span className="bg-canvas-white px-4 text-sm text-gunmetal-gray">أو التسجيل بـ</span>
          </div>
        </div>
